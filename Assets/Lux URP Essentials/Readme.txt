...
Open the "Scriptable Render Pipeline Settings" assigned under "Project Settings" → "Graphics" and check "Depth Texture" and the "Opaque Texture". If you check "Opaque Downsample" or not is up to you.